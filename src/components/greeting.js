    ...
    return (
      <div id="greeting-body">
        ...
        <div className="card-deck">
          <div className="card">
            <Link exact activeClassName="active" to='/YT'><img className="card-img-top" src="http://visionsmithstudio.com/wp-content/uploads/2017/08/yt-viewer.png" alt="Card image cap" /></Link>
          ...
          <div className="card">
            <Link exact activeClassName="active" to='/Weather'><img className="card-img-top" src="http://visionsmithstudio.com/wp-content/uploads/2017/08/weather-2.png" alt="Card image cap" /></Link>
            <div className="card-block">
        ...
        <div className="card-deck card-below">
          <div className="card">
            <Link exact activeClassName="active" to='/ToDo'><img className="card-img-top" src="http://visionsmithstudio.com/wp-content/uploads/2017/08/listapp.png" alt="Card image cap" /></Link>
            <div className="card-block">
          ...
          <div className="card">
            <Link exact activeClassName="active" to='/Translate'><img className="card-img-top" src="http://visionsmithstudio.com/wp-content/uploads/2017/08/translator-2.png" alt="Card image cap" /></Link>
            <div className="card-block">
